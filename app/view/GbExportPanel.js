Ext.define('Gb41.view.GbExportPanel', {
    extend: 'Ext.form.Panel',
    alias: 'widget.gbexportpanel',
 //   requires: ['GbZh.base.ViewerState'],
  ...
  //    map: null, // OpenLayers.Map
    ...
    initComponent: function () {
        ...
        var exportLayersConfig = export_configs[GbZh.base.ViewerState.getActiveTopic()];
            if (!Ext.isArray(exportLayersConfig)) {
                exportLayersConfig = [];
            }

        this.exportLayers = exportLayersConfig;
